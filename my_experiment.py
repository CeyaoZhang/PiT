...
def experiment(
    ...
    is_onehot=variant.get('is_onehot',False)
    save_model=variant.get('save_model',False)
    if save_model:
        save_path=variant.get('save_path','')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='test')  # medium, medium-replay, medium-expert, expert
    ...
    parser.add_argument('--is_onehot',type=bool,default=False)
